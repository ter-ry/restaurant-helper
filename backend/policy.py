...
PERMISSION_ROLES: dict[str, set[str]] = {
    ...
    "menu_costing.manage": {"owner", "manager"},
...
ENDPOINT_PERMISSIONS: dict[str, str] = {
    ...
    "pilot_api.update_pilot_location": "organization.manage",
    ...
    "pilot_api.menu_costing": "menu_costing.manage",
    "pilot_api.create_menu_costing_recipe": "menu_costing.manage",
    "pilot_api.update_menu_costing_recipe": "menu_costing.manage",
    "pilot_api.delete_menu_costing_recipe": "menu_costing.manage",
    "pilot_api.create_menu_costing_recipe_ingredient": "menu_costing.manage",
    "pilot_api.update_menu_costing_recipe_ingredient": "menu_costing.manage",
    "pilot_api.delete_menu_costing_recipe_ingredient": "menu_costing.manage",
    "pilot_api.create_menu_costing_menu_item": "menu_costing.manage",
    "pilot_api.update_menu_costing_menu_item": "menu_costing.manage",
    "pilot_api.delete_menu_costing_menu_item": "menu_costing.manage",
