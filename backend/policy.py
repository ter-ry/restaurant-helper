...
ENDPOINT_PERMISSIONS: dict[str, str] = {
    ...
    "menu_api.menu_costing": "operational.read",
    "menu_api.menu_item_detail": "operational.read",
    "menu_api.create_menu_item": "menu.manage",
    "menu_api.update_menu_item": "menu.manage",
