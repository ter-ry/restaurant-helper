...
export function LandingPage() {
  ...
  return (
    <main className="landing-dark min-h-screen bg-[#f7faf9] text-slate-950">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 lg:grid-cols-[0.9fr_1.1fr] lg:px-8 lg:py-28">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <a href={PRODUCTION_LOGIN_URL} className="landing-cta-primary inline-flex min-h-12 items-center justify-center rounded-xl bg-slate-950 px-5 py-3 text-sm font-bold text-white shadow-sm transition hover:bg-teal-700" onClick={() => trackEvent("cta_request_access_click", { location: "hero" })}>Request access<ArrowRight className="ml-2 h-4 w-4" /></a>
              <a href="#how-it-works" className="landing-cta-secondary inline-flex min-h-12 items-center justify-center rounded-xl border border-slate-300 bg-white px-5 py-3 text-sm font-bold text-slate-950 transition hover:border-teal-500 hover:text-teal-800">See how it works</a>
            </div>
      ...
      <section id="demo" className="landing-reveal mx-auto max-w-7xl px-5 py-20 lg:px-8"><div className="landing-demo-panel rounded-[2rem] bg-teal-800 px-6 py-12 text-white shadow-[0_24px_70px_rgba(15,118,110,0.22)] md:px-12"><Pill>See Flowtally in action</Pill><h2 className="mt-5 max-w-3xl text-3xl font-semibold tracking-tight md:text-4xl">Walk through a populated restaurant workspace.</h2><p className="mt-4 max-w-2xl text-base leading-7 text-teal-50">Harbour Kitchen is a fictional restaurant with realistic purchasing, inventory, menu costing, Square history, and daily close records. It is fully read-only and separate from customer accounts.</p><div className="mt-8 flex flex-col gap-3 sm:flex-row"><a href={OFFICIAL_DEMO_LOGIN_URL} className="landing-demo-primary inline-flex min-h-12 items-center justify-center rounded-xl bg-white px-5 py-3 text-sm font-bold text-teal-900 transition hover:bg-teal-50" onClick={() => trackEvent("cta_view_live_demo_click", { location: "demo_section" })}>View Live Demo<ArrowRight className="ml-2 h-4 w-4" /></a><a href={PRODUCTION_LOGIN_URL} className="landing-demo-secondary inline-flex min-h-12 items-center justify-center rounded-xl border border-teal-300 px-5 py-3 text-sm font-bold text-white transition hover:bg-teal-700" onClick={() => trackEvent("cta_request_access_click", { location: "demo_section" })}>Request access</a></div></div></section>
