...
Keep messages conversational. Do not oversell. The goal is to start local conversations and learn what admin work actually wastes time.

## 5 Short Instagram Openers
...
```text
Hi [Name], quick question: for your restaurant, is the bigger admin headache invoices, daily close, delivery payouts, or bookkeeping handoff?
```
...
```text
Hi [Name], I’m speaking with local food businesses about restaurant admin. No sales pitch - I’m trying to learn what record-keeping work wastes the most time.
```
...
Would you be open to a quick 10-minute conversation about which admin task wastes the most time at your restaurant?
```
...
Would a quick 10-minute chat be possible sometime this week?
```
...
I’m not asking for private numbers. I’m only trying to understand the workflow. Would you be open to a short conversation?
```
...
```text
Just following up once. Even a quick answer helps: is admin pain usually invoices, daily close, delivery payouts, bookkeeping handoff, or something else?
```

2.

```text
No worries if now is busy. If you are open to it later, I’d appreciate even 2-3 sentences on what restaurant admin task wastes the most time.
```

3.

```text
One last note from me. I’m keeping this local and practical - no private data needed. I’m just trying to learn where admin breaks down for real restaurant owners.
```
...
Since you know the restaurant world better than most people I could ask, would you be open to giving me quick feedback or pointing me to someone who might?
```
...
唔需要 private financial data。我只係想了解邊個 admin task 最浪費時間。

你方便用 10 分鐘簡單傾吓嗎?
```

## Restaurant Owner Interview Script
...
1. What admin task takes the most time each week?
2. Which records are involved: POS, invoices, delivery apps, paper notes, spreadsheets, accountant requests?
3. What gets pushed to the end of the night or end of the month?
4. Where do mistakes or missing notes usually happen?
5. Are delivery payouts, supplier invoices, daily close, or bookkeeping handoff more painful?
...
```text
That helps a lot. I’ll keep you updated only if it looks relevant to your workflow. No pressure, and no private data needed.
```
